...
import com.anz.fit.core.date.DateUtils;
...
public class HibernateAuditableListenerTest extends AbstractServiceTest {
    ...
    public void testAudit() {
        ...
        Assert.assertTrue("Created date not set correctly!",
                DateUtils.cleanDateOfTime(new Date()).equals(DateUtils.cleanDateOfTime(saveEntity.getCreatedDate())));
